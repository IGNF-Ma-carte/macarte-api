...
/**
 * @Route("/recuperer-mon-mot-de-passe")
 */
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasherInterface, string $token = null): Response
    {
        ...
        if (null === $token) {
            $this->addFlash('error', "Aucune demande de nouveau mot de passe n'a été trouvée");
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('no-reply@ign.fr', "L'équipe Ma Carte IGN"))
            ->to($user->getEmail())
            ->subject('[Ma Carte IGN] Votre demande de récupération de mot de passe')
